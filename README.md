...
# nestjs-template
* This repository is to create a base [NestJS (with Fastify Adapter) project](https://github.com/nestjs/nest) framework that could be used to easily start up another service and to extend its functionality
